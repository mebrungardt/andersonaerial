...
export default function Home() {
  return (
    <main className="flex min-h-[calc(100vh-310px)] flex-col items-center">
      ...
      >
        <div className="flex justify-center align-middle sm:w-9/12 sm:h-9/12 rounded-lg bg-black flex min-h-[320px] bg-opacity-30">
      ...
      <div className="flex flex-col sm:flex-row justify-around w-full lg:flex bg-cover text-white min-h-[460px] m-4">
        ...
        <div className="flex flex-col justify-around w-full sm:w-3/4 lg:flex border-[#636363] border-y-2 bg-white min-h-[260px] text-center text-[#1780A8] p-8">
      ...
      <div className="flex flex-col sm:flex-row justify-around w-full lg:flex bg-cover text-white min-h-[460px] mb-6 mt-2">
        <div
          className="flex items-center justify-center lg:flex bg-cover text-white min-h-[460px] w-full sm:w-1/2 sm:ml-5 bg-opacity-30"
          style={{
            backgroundImage: `url(${fieldImg.src})`,
          }}
        >
          <div className="bg-opacity-30 bg-white w-full h-full flex items-center justify-center min-h-[460px]">
            <Button text="Services Available" link="/services" />
          </div>
        </div>
        <div
          className="flex items-center justify-center lg:flex bg-cover text-white min-h-[460px] w-full sm:w-1/2 sm:mr-5"
          style={{
