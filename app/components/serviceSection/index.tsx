...
const ServiceSection = ({ title, text, image }: ssProps) => {
  return (
    <div className="flex flex-row justify-around w-full lg:flex text-black min-h-full m-12">
      ...
      <div className="flex flex-col justify-center items-center w-1/3 lg:flex bg-white min-h-[260px] text-[#1780A8] p-8">
        <div
